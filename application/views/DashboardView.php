            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat red">
                    ...
                    <div class="details">
                        ...
                        <div class="desc"  style=" font-weight:bolder;">تعداد کارمندان منفک شده </div>
                    </div>
                    <a class="more" href="javascript:;"style=" font-weight:bolder;font-size:15px">  بیشتر بدانید
                        <i class="m-icon-swapright m-icon-white"></i>
                    </a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat green">
                    ...
                    <div class="details">
                        ...
                        <div class="desc" style=" font-weight:bolder;">تعداد دیپارتمنت ها </div>
                    </div>
                    <a class="more" href="javascript:;" style=" font-weight:bolder;font-size:15px">  بیشتر بدانید
                        <i class="m-icon-swapright m-icon-white"></i>
                    </a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat purple">
                    ...
                    <div class="details">
                        ...
                        <div class="desc" style=" font-weight:bolder;">تعداد </div>
                    </div>
                    <a class="more" href="javascript:;" style=" font-weight:bolder;font-size:15px">  بیشتر بدانید
                        <i class="m-icon-swapright m-icon-white"></i>
                    </a>
