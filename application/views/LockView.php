...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link href="<?=base_url();?>/assets/pages/css/lock-rtl.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page-lock">
            <div class="page-logo">
                <a class="brand" href="index.html">
                    <img src="<?=base_url();?>/assets/logo/LOGO.png" width="200" alt="logo" />
                    
            </div>
            <div class="page-body">
                <div class="lock-head"> صفحه تان قفل شد. </div>
                <div class="lock-body">
                    <div class="pull-left lock-avatar-block">
                        <img src="<?=base_url();?>/assets/pages/media/profile/photo3.jpg" class="lock-avatar"> </div>
                    <form class="lock-form pull-left" action="index.html" method="post">
                        <h4>UserName</h4>
                        <div class="form-group">
                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" /> </div>
                        <div class="form-actions">
                            <button type="submit" class="btn red uppercase">ورود</button>
                        </div>
                    </form>
                </div>
